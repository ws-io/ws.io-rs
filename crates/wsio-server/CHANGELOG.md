...
## 0.14.0 - 2026-09-15T18:51:44Z

[compare changes](https://github.com/ws-io/ws.io-rs/compare/wsio-server-v0.13.0...wsio-server-v0.14.0)

### 🏡 Chore

- upgrade deps ([3f8ef9d](https://github.com/ws-io/ws.io-rs/commit/3f8ef9d977362bae56415fd1df99a89fb14358f2))

### 💅 Refactors

- *(server)* rename `operation_lock` to `lifecycle_lock` ([6f39b14](https://github.com/ws-io/ws.io-rs/commit/6f39b14caef96e01cdf8b2621a0fb338cd7c0250))
...
- make close state handling exhaustive ([9868ae5](https://github.com/ws-io/ws.io-rs/commit/9868ae539514de95892ccc10f072932a8fc39701))
...
- *(server)* validate WebSocket upgrade handshakes ([68a4de7](https://github.com/ws-io/ws.io-rs/commit/68a4de78f3b29f6396ade624d4f4f2a6b27d31d0))

## 0.12.7 - 2026-07-04 04:48

[compare changes](https://github.com/ws-io/ws.io-rs/compare/wsio-server-v0.12.6...wsio-server-v0.12.7)
...
## 0.12.6 - 2026-06-22 04:09

[compare changes](https://github.com/ws-io/ws.io-rs/compare/wsio-server-v0.12.5...wsio-server-v0.12.6)
...
## 0.12.5 - 2026-06-09 16:37

[compare changes](https://github.com/ws-io/ws.io-rs/compare/wsio-server-v0.12.4...wsio-server-v0.12.5)

### 🏡 Chore

- upgrade deps ([1b3e642](https://github.com/ws-io/ws.io-rs/commit/1b3e642))

## 0.12.4 - 2026-06-09 07:05

[compare changes](https://github.com/ws-io/ws.io-rs/compare/wsio-server-v0.12.3...wsio-server-v0.12.4)

### 🏡 Chore

- upgrade deps ([28f7366](https://github.com/ws-io/ws.io-rs/commit/28f7366))
